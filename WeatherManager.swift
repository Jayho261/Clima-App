...
struct WeatherManager{
    ...
    //let weatherURL = "https://api.openweathermap.org/data/2.5/weather?appid=ae838678e245fa6f79e973a4e671632f&units=metric"
    var delegate: WeatherManagerDelegate?
    
    func fetchWeather(lat: String, long: String){
        let weatherURL = "https://api.openweathermap.org/data/2.5/onecall?lat=\(lat)&lon=\(long)&exclude=hourly,minutely&appid=ae838678e245fa6f79e973a4e671632f&units=metric"
